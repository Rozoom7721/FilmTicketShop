...
namespace FilmTicketShop.Data.Services
{
    public class MoviesService : EntityBaseRepository<Movie>, IMoviesService
    {
        ...
        public async Task<NewMovieDropdownsVM> GetNewMovieDropdownsValues()
        {
            ...
            {
                Actors = await _context.Actors.OrderBy(n => n.Id).ToListAsync(),
                Cinemas = await _context.Cinemas.OrderBy(n => n.Id).ToListAsync(),
                Producers = await _context.Producers.OrderBy(n => n.Id).ToListAsync(),
            };
            return response;
        }
